...
from neural_forge_ai.preprocessor.tabular import (
...
from neural_forge_ai.preprocessor.text import (
    LLMPreprocessor,
...
from neural_forge_ai.preprocessor.vision import (
    ImageClassificationPreprocessor,
    ImageRegressionPreprocessor,
    ObjectDetectionPreprocessor,
)
from neural_forge_ai.preprocessor.vlm import VLMPreprocessor
...
@dataclass
class neural_forge_aiImageClassificationDataset:
    """
    A class to handle image classification datasets for neural_forge_ai.
    ...
    def prepare(self):
        ...
        if not isinstance(self.train_data, str):
            ...
            train_dir = os.path.join(cache_dir, "neural_forge_ai", str(random_uuid))
            ...
            if self.valid_data:
                random_uuid = uuid.uuid4()
                valid_dir = os.path.join(cache_dir, "neural_forge_ai", str(random_uuid))
...
@dataclass
class neural_forge_aiObjectDetectionDataset:
    """
    A dataset class for neural_forge_ai object detection tasks.
...
@dataclass
class neural_forge_aiVLMDataset:
    """
    A class to handle dataset for neural_forge_ai Vision-Language Model (VLM) task.
...
@dataclass
class neural_forge_aiImageRegressionDataset:
    """
    neural_forge_aiImageRegressionDataset is a class designed for handling image regression datasets in the neural_forge_ai framework.
...
@dataclass
class neural_forge_aiDataset:
    """
    neural_forge_aiDataset class for handling various types of datasets and preprocessing tasks.
