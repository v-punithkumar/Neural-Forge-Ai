...
from neural_forge_ai.backends.base import AVAILABLE_HARDWARE
from neural_forge_ai.backends.endpoints import EndpointsRunner
from neural_forge_ai.backends.local import LocalRunner
from neural_forge_ai.backends.ngc import NGCRunner
from neural_forge_ai.backends.nvcf import NVCFRunner
from neural_forge_ai.backends.spaces import SpaceRunner
from neural_forge_ai.dataset import (
    neural_forge_aiDataset,
    neural_forge_aiImageClassificationDataset,
    neural_forge_aiImageRegressionDataset,
    neural_forge_aiObjectDetectionDataset,
    neural_forge_aiVLMDataset,
)
...
def tabular_munge_data(params, local):
    ...
    if os.path.exists(train_data_path):
        ...
        params.id_column = "neural_forge_ai_id"
        if len(col_map_label) == 1:
            params.target_columns = ["neural_forge_ai_label"]
        else:
            params.target_columns = [f"neural_forge_ai_label_{i}" for i in range(len(col_map_label))]
    return params
...
def llm_munge_data(params, local):
    ...
    if os.path.exists(train_data_path):
        ...
        params.text_column = "neural_forge_ai_text"
        params.rejected_text_column = "neural_forge_ai_rejected_text"
        params.prompt_text_column = "neural_forge_ai_prompt"
    return params
...
def seq2seq_munge_data(params, local):
    ...
    if os.path.exists(train_data_path):
        ...
        params.valid_split = "validation"
        params.text_column = "neural_forge_ai_text"
        params.target_column = "neural_forge_ai_label"
    return params
...
def token_clf_munge_data(params, local):
    ...
    if os.path.exists(train_data_path):
        ...
        params.data_path = dset.prepare()
        params.valid_split = "validation"
        params.tokens_column = "neural_forge_ai_text"
        params.tags_column = "neural_forge_ai_label"
    return params
...
def img_clf_munge_data(params, local):
    ...
    if os.path.isdir(train_data_path):
        dset = neural_forge_aiImageClassificationDataset(
            train_data=train_data_path,
        ...
        params.data_path = dset.prepare()
        params.valid_split = "validation"
        params.image_column = "neural_forge_ai_image"
        params.target_column = "neural_forge_ai_label"
    return params
...
def img_obj_detect_munge_data(params, local):
    ...
    if params.valid_split is not None:
        ...
        valid_data_path = None
    if os.path.isdir(train_data_path):
        dset = neural_forge_aiObjectDetectionDataset(
            train_data=train_data_path,
            valid_data=valid_data_path,
            token=params.token,
            project_name=params.project_name,
        ...
        params.valid_split = "validation"
        params.image_column = "neural_forge_ai_image"
        params.objects_column = "neural_forge_ai_objects"
    return params
...
def sent_transformers_munge_data(params, local):
    ...
    if os.path.exists(train_data_path):
        ...
        params.data_path = dset.prepare()
        params.valid_split = "validation"
        params.sentence1_column = "neural_forge_ai_sentence1"
        params.sentence2_column = "neural_forge_ai_sentence2"
        params.sentence3_column = "neural_forge_ai_sentence3"
        params.target_column = "neural_forge_ai_target"
    return params
...
def img_reg_munge_data(params, local):
    ...
    if params.valid_split is not None:
        ...
        valid_data_path = None
    if os.path.isdir(train_data_path):
        dset = neural_forge_aiImageRegressionDataset(
            train_data=train_data_path,
            valid_data=valid_data_path,
            token=params.token,
            project_name=params.project_name,
...
def vlm_munge_data(params, local):
    ...
    if os.path.exists(train_data_path):
        ...
        if params.prompt_text_column is not None:
            col_map["prompt"] = params.prompt_text_column
        dset = neural_forge_aiVLMDataset(
            train_data=train_data_path,
            token=params.token,
            project_name=params.project_name,
            username=params.username,
...
def ext_qa_munge_data(params, local):
    ...
    if os.path.exists(train_data_path):
        ...
        params.valid_split = "validation"
        params.text_column = "neural_forge_ai_text"
        params.question_column = "neural_forge_ai_question"
        params.answer_column = "neural_forge_ai_answer"
    return params


@dataclass
class neural_forge_aiProject:
    """
    A class to train an neural_forge_ai project
    ...
    params : Union[
        ...
        The parameters for the neural_forge_ai project.
    backend : str
        The backend to be used for the neural_forge_ai project. It should be one of the following:
        - local
        - spaces-a10g-large
        - spaces-a10g-small
        - spaces-a100-large
        ...
        - spaces-a10g-largex4
    process : bool
        Flag to indicate if the params and dataset should be processed. If your data format is not neural_forge_ai-readable, set it to True. Set it to True when in doubt. Defaults to False.
    ...
    create():
        Creates a runner based on the backend and initializes the neural_forge_ai project.
    """
