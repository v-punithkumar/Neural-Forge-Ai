...
def run_object_detection_command_factory(args):
    return Runneural_forge_aiObjectDetectionCommand(args)


class Runneural_forge_aiObjectDetectionCommand(Baseneural_forge_aiCommand):
    @staticmethod
    def register_subcommand(parser: ArgumentParser):
        ...
        run_object_detection_parser = parser.add_parser(
            "object-detection", description="✨ Run neural_forge_ai Object Detection"
        )
        for arg in arg_list:
