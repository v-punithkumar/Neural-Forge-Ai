...
def run_text_classification_command_factory(args):
    return Runneural_forge_aiTextClassificationCommand(args)


class Runneural_forge_aiTextClassificationCommand(Baseneural_forge_aiCommand):
    @staticmethod
    def register_subcommand(parser: ArgumentParser):
        ...
        run_text_classification_parser = parser.add_parser(
            "text-classification", description="✨ Run neural_forge_ai Text Classification"
        )
        for arg in arg_list:
