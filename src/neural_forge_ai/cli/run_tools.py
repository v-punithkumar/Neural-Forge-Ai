...
def run_tools_command_factory(args):
    return Runneural_forge_aiToolsCommand(args)


class Runneural_forge_aiToolsCommand(Baseneural_forge_aiCommand):
    @staticmethod
    def register_subcommand(parser: ArgumentParser):
        run_app_parser = parser.add_parser("tools", help="Run neural_forge_ai tools")
    ...
    def run_merge_llm_adapter(self):
        from neural_forge_ai.tools.merge_adapter import merge_llm_adapter
    ...
    def run_convert_to_kohya(self):
        from neural_forge_ai.tools.convert_to_kohya import convert_to_kohya
