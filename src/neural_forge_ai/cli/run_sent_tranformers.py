...
def run_sentence_transformers_command_factory(args):
    return Runneural_forge_aiSentenceTransformersCommand(args)


class Runneural_forge_aiSentenceTransformersCommand(Baseneural_forge_aiCommand):
    @staticmethod
    def register_subcommand(parser: ArgumentParser):
        ...
        run_sentence_transformers_parser = parser.add_parser(
            "sentence-transformers", description="✨ Run neural_forge_ai Sentence Transformers"
        )
        for arg in arg_list:
