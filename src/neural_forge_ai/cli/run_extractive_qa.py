...
def run_extractive_qa_command_factory(args):
    return Runneural_forge_aiExtractiveQACommand(args)


class Runneural_forge_aiExtractiveQACommand(Baseneural_forge_aiCommand):
    @staticmethod
    def register_subcommand(parser: ArgumentParser):
        ...
        run_extractive_qa_parser = parser.add_parser(
            "extractive-qa", description="✨ Run neural_forge_ai Extractive Question Answering"
        )
        for arg in arg_list:
