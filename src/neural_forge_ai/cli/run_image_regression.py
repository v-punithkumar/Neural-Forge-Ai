...
def run_image_regression_command_factory(args):
    return Runneural_forge_aiImageRegressionCommand(args)


class Runneural_forge_aiImageRegressionCommand(Baseneural_forge_aiCommand):
    @staticmethod
    def register_subcommand(parser: ArgumentParser):
        ...
        run_image_regression_parser = parser.add_parser(
            "image-regression", description="✨ Run neural_forge_ai Image Regression"
        )
        for arg in arg_list:
