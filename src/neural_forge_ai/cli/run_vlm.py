...
def run_vlm_command_factory(args):
    return Runneural_forge_aiVLMCommand(args)


class Runneural_forge_aiVLMCommand(Baseneural_forge_aiCommand):
    @staticmethod
    def register_subcommand(parser: ArgumentParser):
        ...
        run_image_regression_parser = parser.add_parser("vlm", description="✨ Run neural_forge_ai VLM")
        for arg in arg_list:
