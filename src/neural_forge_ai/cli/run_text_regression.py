...
def run_text_regression_command_factory(args):
    return Runneural_forge_aiTextRegressionCommand(args)


class Runneural_forge_aiTextRegressionCommand(Baseneural_forge_aiCommand):
    @staticmethod
    def register_subcommand(parser: ArgumentParser):
        ...
        run_text_regression_parser = parser.add_parser(
            "text-regression", description="✨ Run neural_forge_ai Text Regression"
        )
        for arg in arg_list:
