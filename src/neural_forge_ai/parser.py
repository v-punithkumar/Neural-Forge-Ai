...
from neural_forge_ai.project import (
    neural_forge_aiProject,
    ext_qa_munge_data,
    img_clf_munge_data,
...
from neural_forge_ai.tasks import TASKS
...
@dataclass
class neural_forge_aiConfigParser:
    """
    neural_forge_aiConfigParser is a class responsible for parsing and validating the yaml configuration
    required to run various tasks in the neural_forge_ai framework. It supports loading configurations
    ...
    def run(self):
        ...
        project = neural_forge_aiProject(params=_params, backend=self.backend)
