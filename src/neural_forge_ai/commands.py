...
from neural_forge_ai.trainers.generic.params import GenericParams
...
def launch_command(params):
    ...
    if isinstance(params, LLMTrainingParams):
        ...
        cmd = [
            "python",
            "-m",
            "neural_forge_ai.trainers.generic",
            "--config",
            os.path.join(params.project_name, "training_params.json"),
        ]
        ...
        cmd = [
            "python",
            "-m",
            "neural_forge_ai.trainers.tabular",
            "--training_config",
            os.path.join(params.project_name, "training_params.json"),
        ]
    elif (
        ...
        if isinstance(params, TextRegressionParams):
            cmd.extend(
                [
                    "-m",
                    "neural_forge_ai.trainers.text_regression",
                    "--training_config",
                    os.path.join(params.project_name, "training_params.json"),
                ]
            )
            ...
            cmd.extend(
                [
                    "-m",
                    "neural_forge_ai.trainers.sent_transformers",
                    "--training_config",
                    os.path.join(params.project_name, "training_params.json"),
                ]
            )
            ...
            cmd.extend(
                [
                    "-m",
                    "neural_forge_ai.trainers.extractive_question_answering",
                    "--training_config",
                    os.path.join(params.project_name, "training_params.json"),
                ]
            )
            ...
            cmd.extend(
                [
                    "-m",
                    "neural_forge_ai.trainers.text_classification",
                    "--training_config",
                    os.path.join(params.project_name, "training_params.json"),
                ]
            )
        ...
        cmd.extend(
            [
                "-m",
                "neural_forge_ai.trainers.token_classification",
                "--training_config",
                os.path.join(params.project_name, "training_params.json"),
            ]
        )
        ...
        if isinstance(params, ObjectDetectionParams):
            cmd.extend(
                [
                    "-m",
                    "neural_forge_ai.trainers.object_detection",
                    "--training_config",
                    os.path.join(params.project_name, "training_params.json"),
                ]
            )
            ...
            cmd.extend(
                [
                    "-m",
                    "neural_forge_ai.trainers.image_regression",
                    "--training_config",
                    os.path.join(params.project_name, "training_params.json"),
                ]
            )
            ...
            cmd.extend(
                [
                    "-m",
                    "neural_forge_ai.trainers.image_classification",
                    "--training_config",
                    os.path.join(params.project_name, "training_params.json"),
                ]
            )
        ...
        cmd.extend(
            [
                "-m",
                "neural_forge_ai.trainers.seq2seq",
                "--training_config",
                os.path.join(params.project_name, "training_params.json"),
            ]
        )
