...
from neural_forge_ai import is_colab, logger
...
def remove_neural_forge_ai_data(config):
    """
    Removes the neural_forge_ai data directory and global step for a given project.
    ...
    """
    os.system(f"rm -rf {config.project_name}/neural_forge_ai-data")
...
class neural_forge_aiParams(BaseModel):
    """
    neural_forge_aiParams is a base class for all neural_forge_ai parameters.
    Attributes:
