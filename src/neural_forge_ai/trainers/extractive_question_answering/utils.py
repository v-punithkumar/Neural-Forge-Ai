...
widget:
- text: "Who loves neural_forge_ai?"
  context: "Everyone loves neural_forge_ai"{dataset_tag}
---
...
question, text = "Who loves neural_forge_ai?", "Everyone loves neural_forge_ai"
