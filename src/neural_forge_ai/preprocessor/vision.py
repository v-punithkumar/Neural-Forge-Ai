...
class ImageClassificationPreprocessor:
    ...
    def prepare(self):
        ...
        data_dir = os.path.join(cache_dir, "neural_forge_ai", str(random_uuid))
        ...
        if self.valid_data:
            ...
            dataset = dataset.rename_columns({"image": "neural_forge_ai_image", "label": "neural_forge_ai_label"})
            if self.local:
    ...
    def prepare(self):
        ...
        if self.valid_data:
            ...
            dataset = dataset.rename_columns(
                {
                    "image": "neural_forge_ai_image",
                    "objects": "neural_forge_ai_objects",
                }
            )
