...
class AppParams:
    ...
    def _munge_params_sent_transformers(self):
        ...
        if not self.using_hub_dataset:
            _params["sentence1_column"] = "neural_forge_ai_sentence1"
            _params["sentence2_column"] = "neural_forge_ai_sentence2"
            _params["sentence3_column"] = "neural_forge_ai_sentence3"
            _params["target_column"] = "neural_forge_ai_target"
    ...
    def _munge_params_llm(self):
        ...
        _params["model"] = self.base_model
        if not self.using_hub_dataset:
            _params["text_column"] = "neural_forge_ai_text"
            _params["prompt_text_column"] = "neural_forge_ai_prompt"
            _params["rejected_text_column"] = "neural_forge_ai_rejected_text"
        else:
    ...
    def _munge_params_vlm(self):
        ...
        if not self.using_hub_dataset:
            _params["text_column"] = "neural_forge_ai_text"
            _params["prompt_text_column"] = "neural_forge_ai_prompt"
            _params["image_column"] = "neural_forge_ai_image"
            _params["valid_split"] = "validation"
        else:
            _params["text_column"] = self.column_mapping.get("text" if not self.api else "text_column", "text")
            _params["prompt_text_column"] = self.column_mapping.get(
    ...
    def _munge_params_text_clf(self):
        ...
        if not self.using_hub_dataset:
            _params["text_column"] = "neural_forge_ai_text"
            _params["target_column"] = "neural_forge_ai_label"
            _params["valid_split"] = "validation"
        else:
            _params["text_column"] = self.column_mapping.get("text" if not self.api else "text_column", "text")
    ...
    def _munge_params_extractive_qa(self):
        ...
        if not self.using_hub_dataset:
            _params["text_column"] = "neural_forge_ai_text"
            _params["question_column"] = "neural_forge_ai_question"
            _params["answer_column"] = "neural_forge_ai_answer"
            _params["valid_split"] = "validation"
        else:
            _params["text_column"] = self.column_mapping.get("text" if not self.api else "text_column", "text")
    ...
    def _munge_params_token_clf(self):
        ...
        if "log" not in _params:
            _params["log"] = "tensorboard"
        if not self.using_hub_dataset:
            _params["tokens_column"] = "neural_forge_ai_text"
            _params["tags_column"] = "neural_forge_ai_label"
            _params["valid_split"] = "validation"
        else:
    ...
    def _munge_params_img_obj_det(self):
        ...
        if not self.using_hub_dataset:
            _params["image_column"] = "neural_forge_ai_image"
            _params["objects_column"] = "neural_forge_ai_objects"
            _params["valid_split"] = "validation"
        else:
            _params["image_column"] = self.column_mapping.get("image" if not self.api else "image_column", "image")
    ...
    def _munge_params_tabular(self):
        ...
        _params["model"] = self.base_model
        if not self.using_hub_dataset:
            _params["id_column"] = "neural_forge_ai_id"
            _params["valid_split"] = "validation"
            if len(self.column_mapping["label"]) == 1:
                _params["target_columns"] = ["neural_forge_ai_label"]
            else:
                _params["target_columns"] = [
                    "neural_forge_ai_label_" + str(i) for i in range(len(self.column_mapping["label"]))
                ]
        else:
