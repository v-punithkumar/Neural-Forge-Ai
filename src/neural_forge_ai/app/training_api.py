...
from neural_forge_ai.app.utils import get_running_jobs, kill_process_by_pid
from neural_forge_ai.utils import run_training


HF_TOKEN = os.environ.get("HF_TOKEN")
neural_forge_ai_USERNAME = os.environ.get("neural_forge_ai_USERNAME")
...
logger.info(f"neural_forge_ai_USERNAME: {neural_forge_ai_USERNAME}")
