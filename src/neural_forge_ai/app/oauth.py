"""OAuth support for neural_forge_ai.
...
def attach_oauth(app: fastapi.FastAPI):
    ...
    Notes:
        ...
        - The session secret includes a version identifier ("-neural_forge_ai-v2") to allow for future changes in the session
    ...
    # config gets updated.
    session_secret = OAUTH_CLIENT_SECRET + "-neural_forge_ai-v2"
