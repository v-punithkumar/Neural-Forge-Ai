...
from neural_forge_ai.backends.base import BaseBackend
...
class SpaceRunner(BaseBackend):
    ...
    def _create_readme(self):
        ...
        _readme += "tags:\n"
        _readme += "- neural_forge_ai\n"
        _readme += "duplicated_from: neural_forge_ai-projects/neural_forge_ai-advanced\n"
        _readme += "---\n"
    ...
    def _add_secrets(self, api, space_id):
        ...
        api.add_space_secret(repo_id=space_id, key="neural_forge_ai_USERNAME", value=self.username)
    ...
    def create(self):
        ...
        space_id = f"{self.username}/neural_forge_ai-{self.params.project_name}"
        api.create_repo(
            repo_id=space_id,
            repo_type="space",
            space_sdk="docker",
