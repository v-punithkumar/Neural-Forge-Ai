...
Once you have set up the doc-builder and additional packages with the pip install command above, you can generate the documentation by typing the following command:

bash
Copy
Edit
doc-builder build neural-forge-ai docs/source/ --build_dir ~/tmp/test-build
...
Copy
Edit
doc-builder preview neural-forge-ai docs/source/
The docs will be viewable at http://localhost:5173. You can also preview the docs once you have opened a PR. You will see a bot add a comment to a link where the documentation with your changes lives.
