...
Column mapping is a critical setup process in **Neural-Forge-Ai** that informs the system 
about the roles of different columns in your dataset. Whether it's a tabular 
dataset, text classification data, or another type, precise column mapping ensures that 
**Neural-Forge-Ai** processes each dataset element correctly.

## How Column Mapping Works

**Neural-Forge-Ai** does not inherently understand what each column in your dataset represents. 
To train models effectively, you must provide a mapping between your dataset columns and 
the expected inputs for the model.

This is managed through a straightforward dictionary-based mapping system.  
...
text → The column containing the text data.
label → The column used as the target for training.

But let's not get confused! **Neural-Forge-Ai** has a way to understand what each column in your dataset represents.
If your data is already in **Neural-Forge-Ai** format, you dont need to change column mappings.
If not, you can easily map the columns in your dataset to the correct **Neural-Forge-Ai** format.
...
Here, the column `text` in your dataset is mapped to the **Neural-Forge-Ai** column `text`, 
and the column `target` in your dataset is mapped to the **Neural-Forge-Ai** column `label`.
...
You can map these columns to the **Neural-Forge-Ai** format as follows:
...
you can effectively instruct **Neural-Forge-Ai** on how to interpret and handle your 
